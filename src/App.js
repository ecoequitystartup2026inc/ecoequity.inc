...
const initialProducts = [
  { id: 1, name: "Heirloom Tomatoes", category: "Organic Edibles", price: 150, image: "/tomato.webp", badge: "Best Seller", stock: "In Stock", emoji: <Cherry size="1em" color="#dc2626" />, description: "Freshly harvested, pesticide-free organic tomatoes, perfect for salads and cooking.", sustainabilityBadge: "Eco-Friendly", rating: 4.8, reviewCount: 124, reviews: [{user: "Maria G.", rating: 5, comment: "Very fresh and juicy!"}, {user: "Jose P.", rating: 4, comment: "Good quality."}] },
  { id: 2, name: "Basil Grow Kit", category: "Herbs", price: 350, image: "/basil.webp", badge: "New", stock: "Low Stock", emoji: <Leaf size="1em" color="var(--eco-c9)" />, description: "Everything you need to grow your own aromatic basil at home. Includes seeds, soil, and pot.", sustainabilityBadge: "Sustainable", rating: 4.5, reviewCount: 89, reviews: [{user: "Ana D.", rating: 5, comment: "Sprouted in just a few days. Love it!"}] },
  { id: 3, name: "Sampaguita Starter", category: "Floriculture", price: 200, image: "/sampaguita.webp", stock: "In Stock", emoji: <Flower2 size="1em" color="#db2777" />, description: "Smells wonderful, arrived healthy.", sustainabilityBadge: "Local & Organic", rating: 4.9, reviewCount: 210, reviews: [{user: "Luz V.", rating: 5, comment: "Smells wonderful, arrived healthy."}] },
  { id: 4, name: "Native Adlai Seeds", category: "Native Seeds", price: 250, image: "/adlai.webp", badge: "Organic", stock: "In Stock", emoji: <Wheat size="1em" color="#d97706" />, description: "High-quality native Adlai seeds, a healthy and sustainable alternative to rice.", sustainabilityBadge: "Local & Organic", rating: 4.7, reviewCount: 56, reviews: [{user: "Mark T.", rating: 4, comment: "Great alternative to rice, high yield."}] },
  { id: 5, name: "Premium Potting Mix", category: "Soil Mixes", price: 280, image: "/potting_mix.webp", stock: "Low Stock", emoji: <Sprout size="1em" color="var(--eco-c9)" />, description: "Nutrient-rich organic potting mix, ideal for all types of plants and urban gardens.", sustainabilityBadge: "Recycled Content", rating: 4.6, reviewCount: 340, reviews: [{user: "Rene C.", rating: 5, comment: "My plants are thriving with this mix."}] },
  { id: 6, name: "Ergonomic Hand Trowel", category: "Gardening Tools", price: 450, image: "/trowel.webp", stock: "In Stock", emoji: <Shovel size="1em" color="var(--eco-c11)" />, description: "Sturdy and comfortable to hold.", sustainabilityBadge: "Essential", rating: 4.8, reviewCount: 112, reviews: [{user: "Sam L.", rating: 5, comment: "Sturdy and comfortable to hold."}] },
  { id: 7, name: "Organic Eggplant", category: "Organic Edibles", price: 120, image: "/eggplant.webp", stock: "In Stock", emoji: <Salad size="1em" color="#7c3aed" />, description: "Fresh, but a bit smaller than expected.", sustainabilityBadge: "Eco-Friendly", rating: 4.3, reviewCount: 45, reviews: [{user: "Karen B.", rating: 4, comment: "Fresh, but a bit smaller than expected."}] },
  { id: 8, name: "Peppermint Seeds", category: "Herbs", price: 90, image: "/mint.webp", stock: "In Stock", emoji: <Sprout size="1em" color="var(--eco-c9)" />, description: "Grows very fast!", sustainabilityBadge: "Sustainable", rating: 4.5, reviewCount: 78, reviews: [{user: "Leo M.", rating: 5, comment: "Grows very fast!"}] },
  { id: 9, name: "Compost Booster", category: "Soil Mixes", price: 320, image: "/compost.webp", badge: "Eco", stock: "In Stock", emoji: <Recycle size="1em" color="var(--eco-c9)" />, description: "Speeds up composting significantly.", sustainabilityBadge: "Eco-Friendly", rating: 4.9, reviewCount: 150, reviews: [{user: "Gina R.", rating: 5, comment: "Speeds up composting significantly."}] },
  { id: 10, name: "Urban Farming Starter Kit", category: "Starter Kits", price: 1200, image: "/starter_kit.webp", badge: "Popular", stock: "In Stock", emoji: <Package size="1em" color="var(--eco-c11)" />, description: "Everything you need to start your urban farm. Includes varied seeds, tools, and premium soil.", sustainabilityBadge: "Eco-Friendly", rating: 4.9, reviewCount: 88, reviews: [{user: "Sarah L.", rating: 5, comment: "Amazing kit to get started!"}] },
  { id: 11, name: "Calamansi Seedling", category: "Organic Edibles", price: 180, image: "/calamansi.webp", badge: "New", stock: "In Stock", emoji: <Citrus size="1em" color="#f59e0b" />, description: "Healthy grafted calamansi seedling, ready to transplant. Bears fruit within 2-3 years.", sustainabilityBadge: "Local & Organic", rating: 4.7, reviewCount: 63, reviews: [{user: "Ramon D.", rating: 5, comment: "Arrived healthy with lots of leaves!"}] },
  { id: 12, name: "Organic Carrots", category: "Organic Edibles", price: 140, image: "/carrot.webp", stock: "In Stock", emoji: <Carrot size="1em" color="#ea580c" />, description: "Sweet, crunchy carrots grown without synthetic pesticides in the Benguet highlands.", sustainabilityBadge: "Eco-Friendly", rating: 4.6, reviewCount: 97, reviews: [{user: "Ella S.", rating: 5, comment: "So sweet and crunchy, kids love them."}] },
  { id: 13, name: "Lemongrass (Tanglad) Bundle", category: "Herbs", price: 110, image: "/lemongrass.webp", stock: "In Stock", emoji: <Leaf size="1em" color="#65a30d" />, description: "Fresh tanglad stalks with roots intact — cook with them or replant in your garden.", sustainabilityBadge: "Local & Organic", rating: 4.8, reviewCount: 132, reviews: [{user: "Nora F.", rating: 5, comment: "Very fragrant, replanted two stalks and they took root."}] },
  { id: 14, name: "Sunflower Seed Pack", category: "Floriculture", price: 130, image: "/sunflower.webp", badge: "New", stock: "In Stock", emoji: <Sun size="1em" color="#f59e0b" />, description: "Giant sunflower variety, easy to grow and pollinator-friendly. About 20 seeds per pack.", sustainabilityBadge: "Sustainable", rating: 4.6, reviewCount: 71, reviews: [{user: "Bea C.", rating: 4, comment: "Most seeds germinated within a week."}] },
  { id: 15, name: "Heirloom Black Rice Seeds", category: "Native Seeds", price: 300, image: "/black_rice.webp", badge: "Organic", stock: "Low Stock", emoji: <Wheat size="1em" color="#7c2d12" />, description: "Traditional pigmented rice seeds from Cordillera farmers, rich in antioxidants.", sustainabilityBadge: "Local & Organic", rating: 4.9, reviewCount: 41, reviews: [{user: "Igor A.", rating: 5, comment: "Rare find, great germination rate."}] },
  { id: 16, name: "Vermicast Organic Fertilizer", category: "Soil Mixes", price: 260, image: "/vermicast.webp", badge: "Eco", stock: "In Stock", emoji: <Recycle size="1em" color="var(--eco-c9)" />, description: "Pure worm castings that enrich soil naturally — gentle enough for seedlings.", sustainabilityBadge: "Eco-Friendly", rating: 4.8, reviewCount: 118, reviews: [{user: "Paolo V.", rating: 5, comment: "My seedlings grew noticeably faster."}] },
  { id: 17, name: "Garden Pruning Shears", category: "Gardening Tools", price: 390, image: "/pruning_shears.webp", stock: "In Stock", emoji: <Scissors size="1em" color="#475569" />, description: "Sharp stainless-steel bypass shears with a comfortable non-slip grip and safety lock.", sustainabilityBadge: "Essential", rating: 4.7, reviewCount: 84, reviews: [{user: "Dan R.", rating: 5, comment: "Clean cuts, feels solid in hand."}] },
  { id: 18, name: "Okra Seeds", category: "Organic Edibles", price: 95, image: "/okra.webp", stock: "In Stock", emoji: <Sprout size="1em" color="var(--eco-c9)" />, description: "Fast-growing native okra variety that thrives in warm Philippine weather. About 30 seeds per pack.", sustainabilityBadge: "Local & Organic", rating: 4.5, reviewCount: 52, reviews: [{user: "Tess M.", rating: 5, comment: "Sprouted in 5 days, very reliable seeds."}] },
  { id: 19, name: "Malunggay Seedling", category: "Organic Edibles", price: 150, image: "/malunggay.webp", badge: "Best Seller", stock: "In Stock", emoji: <Trees size="1em" color="var(--eco-c11)" />, description: "Hardy moringa seedling packed with nutrients — a low-maintenance superfood tree for any backyard.", sustainabilityBadge: "Local & Organic", rating: 4.9, reviewCount: 143, reviews: [{user: "Lito B.", rating: 5, comment: "Grew fast, harvesting leaves within months."}] },
  { id: 20, name: "Oregano Plant", category: "Herbs", price: 160, image: "/oregano.webp", stock: "In Stock", emoji: <Leaf size="1em" color="var(--eco-c9)" />, description: "Established Filipino oregano in a nursery pot — aromatic, medicinal, and nearly impossible to kill.", sustainabilityBadge: "Sustainable", rating: 4.7, reviewCount: 66, reviews: [{user: "Cely N.", rating: 5, comment: "Thick healthy leaves, arrived well-packed."}] },
  { id: 21, name: "Gumamela Cutting", category: "Floriculture", price: 170, image: "/gumamela.webp", stock: "In Stock", emoji: <Flower2 size="1em" color="#dc2626" />, description: "Rooted hibiscus cutting in classic red — blooms year-round and attracts butterflies.", sustainabilityBadge: "Local & Organic", rating: 4.6, reviewCount: 58, reviews: [{user: "Vina O.", rating: 4, comment: "Rooted well, first bloom after a month."}] },
  { id: 22, name: "Native Mung Bean Seeds", category: "Native Seeds", price: 120, image: "/mungbean.webp", badge: "Organic", stock: "In Stock", emoji: <Sprout size="1em" color="#ca8a04" />, description: "Locally sourced munggo seeds for sprouting or field planting — a natural soil nitrogen fixer.", sustainabilityBadge: "Local & Organic", rating: 4.6, reviewCount: 74, reviews: [{user: "Jun P.", rating: 5, comment: "Great germination, made fresh togue in 4 days."}] },
  { id: 23, name: "Cocopeat Grow Blocks", category: "Soil Mixes", price: 190, image: "/cocopeat.webp", badge: "Eco", stock: "In Stock", emoji: <Recycle size="1em" color="#92400e" />, description: "Compressed coconut coir blocks that expand into a light, water-retaining growing medium.", sustainabilityBadge: "Recycled Content", rating: 4.7, reviewCount: 105, reviews: [{user: "Mika T.", rating: 5, comment: "One block expanded so much, great value."}] },
  { id: 24, name: "Drip Irrigation Kit", category: "Gardening Tools", price: 650, image: "/drip_kit.webp", badge: "New", stock: "Low Stock", emoji: <Droplet size="1em" color="#0ea5e9" />, description: "Water-saving drip kit for up to 20 plants — timers, tubing, and drippers included.", sustainabilityBadge: "Eco-Friendly", rating: 4.8, reviewCount: 39, reviews: [{user: "Arlo G.", rating: 5, comment: "Cut my watering time to zero, plants love it."}] },
  { id: 25, name: "Herb Garden Starter Kit", category: "Starter Kits", price: 850, image: "/herb_kit.webp", badge: "Popular", stock: "In Stock", emoji: <Package size="1em" color="var(--eco-c11)" />, description: "Grow basil, mint, and oregano from one box — pots, soil discs, seeds, and a care guide included.", sustainabilityBadge: "Sustainable", rating: 4.8, reviewCount: 92, reviews: [{user: "Faye R.", rating: 5, comment: "Perfect gift, everything you need is inside."}] },
  { id: 26, name: "Pechay Seeds", category: "Organic Edibles", price: 85, image: "/pechay.webp", stock: "In Stock", emoji: <Salad size="1em" color="var(--eco-c9)" />, description: "Quick-harvest native pechay — ready to eat in just 30 days, perfect for container gardens.", sustainabilityBadge: "Local & Organic", rating: 4.6, reviewCount: 88, reviews: [{user: "Rosa E.", rating: 5, comment: "Harvested in a month, super easy to grow."}] },
  { id: 27, name: "Sili Labuyo Seedling", category: "Organic Edibles", price: 135, image: "/labuyo.webp", badge: "Hot", stock: "In Stock", emoji: <Flame size="1em" color="#dc2626" />, description: "Fiery native bird's eye chili seedling — compact, productive, and thrives in pots.", sustainabilityBadge: "Local & Organic", rating: 4.8, reviewCount: 67, reviews: [{user: "Ben K.", rating: 5, comment: "Loaded with chilis after two months!"}] },
  { id: 28, name: "Pandan Plant", category: "Herbs", price: 145, image: "/pandan.webp", stock: "In Stock", emoji: <Leaf size="1em" color="var(--eco-c11)" />, description: "Fragrant pandan in a nursery pot — fresh leaves on demand for rice, drinks, and desserts.", sustainabilityBadge: "Local & Organic", rating: 4.7, reviewCount: 79, reviews: [{user: "Ina C.", rating: 5, comment: "So fragrant, my kitchen staple now."}] },
  { id: 29, name: "Waling-Waling Orchid Seedling", category: "Floriculture", price: 450, image: "/walingwaling.webp", badge: "Rare", stock: "Low Stock", emoji: <Flower2 size="1em" color="#7c3aed" />, description: "The queen of Philippine orchids — nursery-propagated seedling with care instructions included.", sustainabilityBadge: "Local & Organic", rating: 4.9, reviewCount: 34, reviews: [{user: "Cora H.", rating: 5, comment: "Healthy roots, a dream to finally own one."}] },
  { id: 30, name: "Native Ube Tubers", category: "Native Seeds", price: 220, image: "/ube.webp", badge: "Organic", stock: "In Stock", emoji: <Sprout size="1em" color="#7c3aed" />, description: "Planting-grade purple yam tubers from local growers — grow your own ube at home.", sustainabilityBadge: "Local & Organic", rating: 4.7, reviewCount: 48, reviews: [{user: "Manny Q.", rating: 5, comment: "Sprouted quickly, excited for harvest."}] },
  { id: 31, name: "Carbonized Rice Hull", category: "Soil Mixes", price: 150, image: "/rice_hull.webp", badge: "Eco", stock: "In Stock", emoji: <Wheat size="1em" color="#57534e" />, description: "Upcycled rice hulls that improve drainage and aeration — a Filipino farming classic.", sustainabilityBadge: "Recycled Content", rating: 4.6, reviewCount: 93, reviews: [{user: "Oscar D.", rating: 5, comment: "My potting mix drains so much better now."}] },
  { id: 32, name: "Bamboo Garden Stakes (10 pcs)", category: "Gardening Tools", price: 120, image: "/bamboo_stakes.webp", stock: "In Stock", emoji: <Trees size="1em" color="#92400e" />, description: "Sturdy locally sourced bamboo stakes for supporting tomatoes, beans, and climbing vines.", sustainabilityBadge: "Sustainable", rating: 4.5, reviewCount: 61, reviews: [{user: "Pia W.", rating: 4, comment: "Strong stakes, good length for tomatoes."}] },
  { id: 33, name: "Kids Gardening Kit", category: "Starter Kits", price: 950, image: "/kids_kit.webp", badge: "New", stock: "In Stock", emoji: <Gift size="1em" color="#db2777" />, description: "Child-friendly tools, fast-sprouting seeds, and activity cards to get little hands growing.", sustainabilityBadge: "Sustainable", rating: 4.9, reviewCount: 45, reviews: [{user: "Joy A.", rating: 5, comment: "My daughter checks her sprouts every morning!"}] },
];
...
const styles = {
  ...
  page: {
    ...
    // backgroundImage: "url('/IMG_6223.webp')",
    overflow: "hidden",
    position: "relative",
    display: "flex",
    alignItems: "center",
